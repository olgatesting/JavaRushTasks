...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File your_file_name = File.createTempFile("C:\\Users\\User\\Desktop\\DreamJob\\Java\\file1.txt", null);
            ...
            if (ivanov.equals(somePerson)) {
                System.out.println("These men are equal");
            } else {
                System.out.println("These men aren't equal");
            }
